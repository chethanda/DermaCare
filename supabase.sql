...
VALUES 
('11111111-1111-1111-1111-111111111111', 'Dr. Ananya Deshmukh', 'Aesthetic Dermatology & Laser Therapy', 'MD (AIIMS New Delhi), FRCP', 14, '/doctors/ananya.png', 'Specialized in facial rejuvenation, acne scar removal, and advanced glow lasers.'),
('22222222-2222-2222-2222-222222222222', 'Dr. Rajesh Iyer', 'Clinical Dermatology & Hair Restoration', 'MD, DNB (BMCRI Bengaluru)', 12, '/doctors/rajesh.png', 'Expert in complex skin conditions, scalp rejuvenation, and anti-pigmentation care.'),
('33333333-3333-3333-3333-333333333333', 'Dr. Sunita Rao', 'Pediatric & Cosmetic Skin Care', 'MD Dermatology (Manipal University)', 9, '/doctors/sunita.png', 'Focuses on holistic skin health, collagen restoration, and sensitive skin solutions.'),
('44444444-4444-4444-4444-444444444444', 'Dr. Vikramaditya Kulkarni', 'Laser Resurfacing & Anti-Aging', 'MD (St. John''s Medical College)', 15, '/doctors/vikramaditya.png', 'Pioneer in non-surgical skin lifting, dermal fillers, and precision laser skin tightening.')
ON CONFLICT (id) DO NOTHING;
